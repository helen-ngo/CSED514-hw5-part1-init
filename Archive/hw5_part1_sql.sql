...
CREATE TABLE Vaccines(
	VaccineId INT IDENTITY(0,1) PRIMARY KEY,
	VaccineBrand varchar(50),
    DosesOnHand INT DEFAULT 0 NOT NULL,
...
INSERT INTO Vaccines (VaccineBrand, VaccineMinAge, DoseSeries, DoseVolume)
	VALUES ('Johnson & Johnson’s Janssen', 18, 1, 0.5);
INSERT INTO Vaccines (VaccineBrand, VaccineMinAge, DoseSeries, IntervalBetweenDoses, DoseVolume)
	VALUES ('Pfizer-BioNTech', 16, 2, 21, 0.3);
INSERT INTO Vaccines (VaccineBrand, VaccineMinAge, DoseSeries, IntervalBetweenDoses, DoseVolume)
	VALUES ('Moderna', 18, 2, 28, 0.5);
